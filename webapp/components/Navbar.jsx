      ...
      <nav className={`navbar ${isCollapsed ? 'collapsed-mobile' : ''} ${isTracker ? 'navbar-tracker' : ''}`}>
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          ...
          <div className="nav-links desktop-only">
            ...
            <div className="nav-socials" style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
              ...
              <a href="https://pin.it/64nvnZg6i" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" style={{ display: 'inline-flex', alignItems: 'center' }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="var(--color-purple)"><g transform="translate(-6, 0)"><path d="M9.686 18.885c.219-.937 1.406-5.957 1.406-5.957s-.359-.72-.359-1.781c0-1.663.967-2.911 2.168-2.911 1.02 0 1.513.769 1.513 1.688 0 1.027-.653 2.567-.992 3.993-.284 1.194.598 2.169 1.776 2.169 2.133 0 3.772-2.249 3.772-5.495 0-2.873-2.064-4.882-5.012-4.882-3.414 0-5.418 2.561-5.418 5.207 0 1.031.397 2.138.893 2.738.098.119.112.224.083.345l-.333 1.36c-.053.22-.174.267-.402.161-1.499-.698-2.436-2.889-2.436-4.649 0-3.785 2.75-7.262 7.929-7.262 4.163 0 7.397 2.967 7.397 6.931 0 4.136-2.607 7.464-6.227 7.464-1.216 0-2.359-.631-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146"/></g></svg>
              </a>
            </div>
          </div>

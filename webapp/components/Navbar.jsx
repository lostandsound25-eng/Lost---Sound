        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
          ...
          <div className="nav-links desktop-only">
            ...
            <div className="nav-socials" style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <a href="https://www.tiktok.com/@lostandsound.jpg?_r=1&_t=ZS-96DtrMvLXi1" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{ display: 'inline-flex', alignItems: 'center', marginLeft: '-2px' }}>
              ...
              <a href="https://pin.it/64nvnZg6i" target="_blank" rel="noopener noreferrer" aria-label="Pinterest" style={{ display: 'inline-flex', alignItems: 'center', marginLeft: '-7px' }}>

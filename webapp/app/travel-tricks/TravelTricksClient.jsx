...
import { AFFILIATE_LINKS, getAffiliateLink } from '../../lib/affiliateLinks';
...
export default function TravelTricksClient() {
  ...
  const mustPackItems = [
    { name: 'Osprey 70L & 55L Packs', tag: 'Must-Have Luggage', desc: 'Our primary carry-on backpack setup', icon: '🎒', link: getAffiliateLink('osprey_70l') },
    ...
    { name: 'Universal Travel Adapter', tag: 'Tech Essential', desc: 'All-in-one global surge protector', icon: '🔌', link: getAffiliateLink('universal_adapter') },
    { name: 'Salomon & Altra Runners', tag: 'Footwear', desc: 'For mountain hikes & long city walks', icon: '👟', link: getAffiliateLink('salomon_runners') },
    { name: 'Osmo Pocket 3 / DJI Drone', tag: 'Camera & Vlogging', desc: 'For stabilized travel footage & aerials', icon: '📹', link: getAffiliateLink('osmo_pocket_3') },
  ];
  ...
  const gearItems = [
    ...
    { name: 'Osmo Pocket 3', desc: 'Stabilized vlogging camera', category: 'Tech', link: getAffiliateLink('osmo_pocket_3'), icon: '📹' },
    ...
    { name: 'Universal Travel Adapter', desc: 'Global surge-protected plug', category: 'Tech', link: getAffiliateLink('universal_adapter'), icon: '🔌' },
    ...
    { name: 'Osprey 70L & 55L Packs', desc: 'Primary carry-on travel packs', category: 'Luggage', link: getAffiliateLink('osprey_70l'), icon: '🎒' },
    { name: 'Compression Packing Cubes', desc: 'Saves 40% luggage volume', category: 'Luggage', link: getAffiliateLink('packing_cubes'), icon: '📦' },
    { name: 'Heavy-Duty Carabiners', desc: 'Clips shoes & wet gear outside', category: 'Luggage', link: getAffiliateLink('carabiners'), icon: '🧗' },

    { name: 'Salomon Trail Runners', desc: 'Hiking & city walk shoes', category: 'Footwear', link: getAffiliateLink('salomon_runners'), icon: '👟' },
    { name: 'Altra Wide-Toe Runners', desc: 'Ergonomic long-distance shoes', category: 'Footwear', link: getAffiliateLink('ultra_runners'), icon: '🏃' },
    ...
    { name: 'Beach Blanket (Ticket to Moon)', desc: 'Parachute silk quick-dry blanket', category: 'Comfort', link: getAffiliateLink('beach_blanket'), icon: '🏖️' },
    { name: 'Quick-Dry Microfiber Towels', desc: 'Compact palm-sized towels', category: 'Comfort', link: getAffiliateLink('microfiber_towel'), icon: '🧼' },
    { name: '3D Sleeping Contour Mask', desc: '100% light blackout mask', category: 'Comfort', link: getAffiliateLink('sleeping_mask'), icon: '😴' },
    { name: 'Rechargeable Headlamp', desc: 'Hands-free night & cave light', category: 'Comfort', link: getAffiliateLink('headlamp'), icon: '🔦' },
  ];
    ...
    <main style={{ backgroundColor: '#F4F1EA', minHeight: '100vh', padding: '90px 16px 100px' }}>
      <div className="container" style={{ maxWidth: '1020px', margin: '0 auto' }}>
        ...
        <header style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <h1 style={{ fontSize: '3.1rem', color: 'var(--color-purple)', fontFamily: 'var(--font-heading)', margin: '0 0 10px', lineHeight: 1.05 }}>
            Long-Term Travel Tips & Tools to Simplify Your Journey
          </h1>
